...
- 使用HTML来编写UI相关代码。
- 不要移除没有使用的`<style asp-location="true">`、`<script asp-location="Head">`、`<script asp-location="Footer">`等标签。
- 如果没有特殊要求，且有提供设计稿，则UI代码应尽量贴近设计稿。
- 如果没有设计稿，则UI代码应尽量贴近原有代码。
- 如果没有设计稿，且没有原有代码，则UI代码应尽量贴近设计稿。
- 如果没有设计稿，且没有原有代码，且没有设计稿，则UI代码应尽量贴近原有代码。
